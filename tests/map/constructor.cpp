...
int main(int argc, char **argv)
{
    ...
    (void) argv;
    const long SIZE = 5;
    TEST_NAMESPACE::map<int, char> testVector;
    ...
    TEST_NAMESPACE::map<int> testVector2(testVector);
    ...
    TEST_NAMESPACE::map<int> testVector3(5, 10);
    ...
    TEST_NAMESPACE::map<int> testVector4(testVector3.begin(), testVector3.end());
    ...
    {
        TEST_NAMESPACE::map<int> tmp = testVector4;
    }
